...
<body>
    ...
    <div class="Admincontainer">
        <a href="admin_Reservation-stats.php" class="adminbutton">View Reservations</a>
        <a href="admin_addcourse.php" class="adminbutton">Add Courses</a>
        <a href="admin_deleteCoursePage.php" class="adminbutton">Remove Courses</a>
        <a href="admin_registration.php" class="adminbutton">Add New Administrator</a>
    </div>
